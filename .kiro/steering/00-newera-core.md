...
- Runtime layering: steering giữ guardrail ngắn; skills giữ workflow; agents giữ role/tool/permission/resource; hooks giữ event automation. Không chép policy canonical vào runtime layer.
